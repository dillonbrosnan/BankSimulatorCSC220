...
class ServiceArea {
  ...
  public ServiceArea(int numTellers, int customerQlimit)
  {
      ...
      freeTellerQ = new ArrayDeque<> (numTellers);
      
      for (int i = 1; i <= numTellers; i++){
          freeTellerQ.add(new Teller(i));
          //System.out.println("Teller " + (i) + " has been added to freeTellerQ initial");
      }
      freeTellerQ.toString();
	...
	// construct PriorityQueue object
 	// overide compare() in Comparator to compare Teller objects
      CompareTellers comp = new CompareTellers();
  ...
  public Teller removeFreeTellerQ()
  {
	...
	// Add statetments
      //System.out.println("Teller " + freeTellerQ.peek().getTellerID() + " removed from FreeTellerQ");
  ...
  public Teller removeBusyTellerQ() 
  {
	...
	// Add statetments
      //System.out.println("Teller " + busyTellerQ.peek().getTellerID() + "removed from busy q");
  ...
  public Customer removeCustomerQ()
  {
	...
	// Add statetments
      //System.out.println("Customer " + customerQ.peek().getCustomerID() + " has been removed from customer q");
...
//      System.out.println("teller " + freeTellerQ.peek().getCustomer().toString() + " has been added to free teller q");
  ...
  public void insertBusyTellerQ(Teller teller)
  {
      ...
      //System.out.println("teller " + teller.getTellerID() + " has been added to busy teller q");
      //System.out.println("Total Busy Teller Q: " + busyTellerQ.toString());
      //System.out.println(busyTellerQ.peek().toString() + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
  ...
  public void insertCustomerQ(Customer customer)
  {
	...
	customerQ.add(customer);
        ...
        //System.out.println("customer " + customer.getCustomerID() + " has been added to customer q");
